//! Exact fixed-profile escrow port from frozen solana_escrow.c; synthetic mint only.
use solana_program::{
...
const MINT_ID: [u8; 32] = [202,147,172,23,5,24,112,113,214,123,131,199,255,14,254,129,8,232,236,69,48,87,93,119,38,135,147,51,219,218,190,124];
