...
std::vector<AdvancedCommand> allCommands()
{
    return
    {
        ...
        AdvancedCommand("rescan", "Recheck the chain while preserving local recipient history", true, true),
        AdvancedCommand("reset", "Recheck the chain and discard local recipient history", true, true),
