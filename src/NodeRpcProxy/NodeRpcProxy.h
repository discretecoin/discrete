...
public:
  ...
  void getSwapOutpoint(const Crypto::Hash& txid, uint32_t index, const Crypto::Hash& spendTag,
...
private:
  ...
  std::error_code doGetSwapOutpoint(Crypto::Hash txid, uint32_t index, Crypto::Hash spendTag,
